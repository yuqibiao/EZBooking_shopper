...
public class RefreshLayout extends SwipeRefreshLayout implements NestedScrollingParent{
    ...
    public RefreshLayout(Context context, AttributeSet attrs) {
        ...
        mListViewFooter = LayoutInflater.from(context).inflate(R.layout.lodding_more, null, false);
    }
