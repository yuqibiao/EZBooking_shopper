...
public class ViewpagerLooper extends LinearLayout {
     ...
     * 圆点View的大小
     */
    private float DOT_VIEW_SIZE = TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 15, getResources().getDisplayMetrics());
    ...
    public static abstract class LooperPagerAdapter<T> extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            View viewItem = LayoutInflater.from(mContext).inflate(containerId, container, false);
